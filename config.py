...
# Precision setup for transcendental verification signatures
PRECISION_CONTEXT = 120

# Spectral reflectance profiles for terrain classification
RASTER_BAND_PROPERTIES = {
    1: {"type": "Dense Canopy (High NDVI)", "reflectance_mean": 0.85},
    2: {"type": "Urban Core (Built Environment)", "reflectance_mean": 0.45},
    3: {"type": "Water Feature (Low Infrared)", "reflectance_mean": 0.12},
    4: {"type": "Cloud Cover (Sensor Occlusion)", "reflectance_mean": 0.00}, 
    5: {"type": "Interpolated (Cloud-Cleansed Patch)", "reflectance_mean": 0.60},
    0: {"type": "RESTRICTED / EXCLUSION ZONE BUFFER", "reflectance_mean": -1.00}
}

# The explicit 24-condition architectural safety registry
SYSTEM_CONDITIONS = [
...
STANDARD_BASE_CEILING = 1 + len(SYSTEM_CONDITIONS)

# Working Conditions Modifier: Double the standard base (25 * 2 = 50 Units)
DOUBLED_WORKING_CEILING = STANDARD_BASE_CEILING * 2
